...
public final class Controller<I, O> {
    ...
    final GingesterNext.ControllerInterface gingester;
    ...
    public Controller(ControllerConfiguration<I, O> configuration, GingesterNext.ControllerInterface gingester) {
