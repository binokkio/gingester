...
class ToJsonTest {
    ...
    void testPlainCsv() throws Exception {
        ...
        toJson.transform(
                ...
                getClass().getResourceAsStream("/b/nana/technology/gingester/transformers/base/data/dsv/test.csv"),
    ...
    void testDsv() throws Exception {
        ...
        toJson.transform(
                new Context.Builder().build(),
                getClass().getResourceAsStream("/b/nana/technology/gingester/transformers/base/data/dsv/test.dsv"),
                (UniReceiver<JsonNode>) results::add
        );
    ...
    void testWithEscapeCharacter() throws Exception {
        ...
        toJson.transform(
                new Context.Builder().build(),
                getClass().getResourceAsStream("/b/nana/technology/gingester/transformers/base/data/dsv/with-escapes.csv"),
                (UniReceiver<JsonNode>) results::add
        );
    ...
    void testWithExtras() throws Exception {
        ...
        toJson.transform(
                new Context.Builder().build(),
                getClass().getResourceAsStream("/b/nana/technology/gingester/transformers/base/data/dsv/with-extras.csv"),
                (UniReceiver<JsonNode>) results::add
        );
