...
class OuterJoinTest {
    ...
    void testOneToOneJoin() {
        ...
        new Gingester().cli("" +
                "-ss joinAs numbers -t JsonCreate [{id:1,value:11111},{id:2,value:22222},{id:3,value:33333}] -l JsonStream " +
                "-ss joinAs letters -t JsonCreate [{id:1,value:'aaa'},{id:2,value:'bbb'},{id:3,value:'ccc'}] -l JsonStream " +
                "-t JsonStream '$[*]' " +
                "-s value " +
                "-t JsonPath '$.id' " +
                "-t OuterJoin")
    ...
    void testJoin3() {
        ...
        new Gingester().cli("" +
                "-ss joinAs numbers -t JsonCreate [{id:1,value:11111},{id:2,value:22222},{id:3,value:33333}] -l JsonStream " +
                "-ss joinAs upper -t JsonCreate [{id:1,value:'AAA'},{id:2,value:'BBB'},{id:3,value:'CCC'}] -l JsonStream " +
                "-ss joinAs lower -t JsonCreate [{id:1,value:'aaa'},{id:2,value:'bbb'},{id:3,value:'ccc'}] -l JsonStream " +
                "-t JsonStream '$[*]' " +
                "-s value " +
                "-t JsonPath '$.id' " +
                "-t OuterJoin")
